        ...
        <div class="card">
            <div class="card-body">
                <div class="card-header py-3">
                    <h5 class="mb-0 text-center"><strong>Edit Product</strong></h5>
                </div>
                <!-- Name input -->
                @if ($errors->any())
                ...
                <!-- Slug input -->
                <div class="form-outline mb-4">
                    <input name="slug" id="form7Example2" class="form-control" value="{{ $product->slug }}" />
                    <label class="form-label" for="form7Example2">Slug</label>
                </div>
                <!-- Description input -->
                <div class="form-outline mb-4">
                    <input name="description" id="form7Example2" class="form-control" value="{{ $product->description }}" />
                    <label class="form-label" for="form7Example2">Description</label>
                </div>
                <!-- Image input -->
                <div class="form-outline mb-4">
                    <input name="image" id="form7Example2" class="form-control" value="{{ $product->image }}" />
